...
public static class CSSStyleDeclarationExtensions
{
    ...
    public static ObjBuilder<string> getPropertyPriority(this ObjBuilder<CSSStyleDeclaration> b, Var<string> property)
    {
    ...
    public static ObjBuilder<string> getPropertyValue(this ObjBuilder<CSSStyleDeclaration> b, Var<string> property)
    {
    ...
    public static ObjBuilder<string> item(this ObjBuilder<CSSStyleDeclaration> b, Var<int> index)
    {
    ...
    public static ObjBuilder<string> removeProperty(this ObjBuilder<CSSStyleDeclaration> b, Var<string> property)
    {
    ...
    public static void setProperty(this ObjBuilder<CSSStyleDeclaration> b, Var<string> propertyName, Var<string> value)
    {
    ...
    /// </param>
    /// <remarks>value must not contain "!important", that should be set using the priority parameter.</remarks>
    public static void setProperty(this ObjBuilder<CSSStyleDeclaration> b, Var<string> propertyName, Var<string> value, Var<string> priority)
    {
