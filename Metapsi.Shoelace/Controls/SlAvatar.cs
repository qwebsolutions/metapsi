...
public static partial class SlAvatarControl
{
    ...
    /// <para> The image could not be loaded. This may because of an invalid URL, a temporary network condition, or some unknown cause. </para>
    /// </summary>
    public static void OnSlError<TComponent, TModel>(this PropsBuilder<TComponent> b, Var<HyperType.Action<TModel>> action) where TComponent: SlAvatar
    {
        b.OnEventAction("onsl-error", action);
    }
    /// <summary>
    /// <para> The image could not be loaded. This may because of an invalid URL, a temporary network condition, or some unknown cause. </para>
    /// </summary>
    public static void OnSlError<TComponent, TModel>(this PropsBuilder<TComponent> b, System.Func<SyntaxBuilder, Var<TModel>, Var<TModel>> action) where TComponent: SlAvatar
    {
        b.OnEventAction("onsl-error", b.MakeAction(action));
    }
