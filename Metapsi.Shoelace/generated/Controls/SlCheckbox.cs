...
public static partial class SlCheckboxControl
{
    ...
    /// </summary>
    public static void SetValidity<T>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<string> validity) where T: SlCheckbox
    {
    ...
    /// Gets the validity state object
    /// </summary>
    public static void SetValidity<T>(this Metapsi.Syntax.PropsBuilder<T> b, string validity) where T: SlCheckbox
    {
    ...
    /// </summary>
    public static void SetValidationMessage<T>(this Metapsi.Syntax.PropsBuilder<T> b, Metapsi.Syntax.Var<string> validationMessage) where T: SlCheckbox
    {
    ...
    /// Gets the validation message
    /// </summary>
    public static void SetValidationMessage<T>(this Metapsi.Syntax.PropsBuilder<T> b, string validationMessage) where T: SlCheckbox
    {
