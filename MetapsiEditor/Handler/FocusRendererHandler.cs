...
{
    public class FocusRenderer : Http.Get<Metapsi.Live.Route.FocusRenderer, string>
    {
        public class Model
        {
        ...
        public override async Task<IResult> OnGet(CommandContext commandContext, HttpContext httpContext, string rendererName)
        {
            ...
            return Page.Result(new Model()
            {
                ...
                Renderer = await commandContext.Do(Backend.GetFocusedRenderer)
            });
        }
    }
}