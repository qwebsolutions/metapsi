...
public static partial class IonItemControl
{
    ...
    {
        return b.IonicTag("ion-item", new System.Collections.Generic.Dictionary<string, string>(), children);
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColor(this Metapsi.Html.AttributesBuilder<IonItem> b, string color) 
    {
    ...
    {
        b.SetAttribute("detailIcon", detailIcon);
    }
    ...
    /// If `true`, a button tag will be rendered and the item will be tappable.
    /// </summary>
    public static void SetButton<T>(this Metapsi.Syntax.PropsBuilder<T> b, bool button) where T: IonItem
    {
    ...
    {
        b.SetProperty(b.Props, b.Const("detail"), detail);
    }

    /// <summary>
    /// If `true`, a detail arrow will appear on the item. Defaults to `false` unless the `mode` is `ios` and an `href` or `button` property is present.
    /// </summary>
    public static void SetDetail<T>(this Metapsi.Syntax.PropsBuilder<T> b, bool detail) where T: IonItem
    {
        b.SetDetail(b.Const(detail));
    }
    ...
    {
        b.SetProperty(b.Props, b.Const("detailIcon"), detailIcon);
    }

    /// <summary>
    /// The icon to use when `detail` is set to `true`.
    /// </summary>
    public static void SetDetailIcon<T>(this Metapsi.Syntax.PropsBuilder<T> b, string detailIcon) where T: IonItem
    {
        b.SetDetailIcon(b.Const(detailIcon));
    }
    ...
    /// If `true`, the user cannot interact with the item.
    /// </summary>
    public static void SetDisabled<T>(this Metapsi.Syntax.PropsBuilder<T> b, bool disabled) where T: IonItem
    {
    ...
    /// This attribute instructs browsers to download a URL instead of navigating to it, so the user will be prompted to save it as a local file. If the attribute has a value, it is used as the pre-filled file name in the Save prompt (the user can still change the file name if they want).
    /// </summary>
    public static void SetDownload<T>(this Metapsi.Syntax.PropsBuilder<T> b, string download) where T: IonItem
    {
    ...
    /// Contains a URL or a URL fragment that the hyperlink points to. If this property is set, an anchor tag will be rendered.
    /// </summary>
    public static void SetHref<T>(this Metapsi.Syntax.PropsBuilder<T> b, string href) where T: IonItem
    {
    ...
    /// Specifies the relationship of the target object to the link object. The value is a space-separated list of [link types](https://developer.mozilla.org/en-US/docs/Web/HTML/Link_types).
    /// </summary>
    public static void SetRel<T>(this Metapsi.Syntax.PropsBuilder<T> b, string rel) where T: IonItem
    {
    ...
    /// Specifies where to display the linked URL. Only applies when an `href` is provided. Special keywords: `"_blank"`, `"_self"`, `"_parent"`, `"_top"`.
    /// </summary>
    public static void SetTarget<T>(this Metapsi.Syntax.PropsBuilder<T> b, string target) where T: IonItem
    {
