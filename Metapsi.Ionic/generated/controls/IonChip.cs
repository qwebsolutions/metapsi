...
public static partial class IonChipControl
{
    ...
    {
        return b.IonicTag("ion-chip", new System.Collections.Generic.Dictionary<string, string>(), children);
    }
    ...
    /// The color to use from your application's color palette. Default options are: `"primary"`, `"secondary"`, `"tertiary"`, `"success"`, `"warning"`, `"danger"`, `"light"`, `"medium"`, and `"dark"`. For more information on colors, see [theming](/docs/theming/basics).
    /// </summary>
    public static void SetColor(this Metapsi.Html.AttributesBuilder<IonChip> b, string color) 
    {
    ...
    /// If `true`, the user cannot interact with the chip.
    /// </summary>
    public static void SetDisabled<T>(this Metapsi.Syntax.PropsBuilder<T> b, bool disabled) where T: IonChip
    {
    ...
    /// Display an outline style button.
    /// </summary>
    public static void SetOutline<T>(this Metapsi.Syntax.PropsBuilder<T> b, bool outline) where T: IonChip
    {
