...
public static partial class IonCheckboxControl
{
    ...
    public static void OnIonChange<TModel>(this PropsBuilder<IonCheckbox> b, Var<HyperType.Action<TModel, CheckboxChangeEventDetail>> action)
    {
        ...
        {
            var value = b.GetDynamic(eventArgs, new DynamicProperty<CheckboxChangeEventDetail>("detail"));
            return b.MakeActionDescriptor<TModel, CheckboxChangeEventDetail>(action, value);
        });
    ...
    public static void OnIonChange<TModel>(this PropsBuilder<IonCheckbox> b, System.Func<SyntaxBuilder, Var<TModel>, Var<CheckboxChangeEventDetail>, Var<TModel>> action)
    {
        ...
        {
            var value = b.GetDynamic(eventArgs, new DynamicProperty<CheckboxChangeEventDetail>("detail"));
            return b.MakeActionDescriptor<TModel, CheckboxChangeEventDetail>(b.MakeAction(action), value);
        });
        b.SetDynamic(b.Props, new DynamicProperty<HyperType.Action<TModel, object>>("onionChange"), eventAction);
    }
