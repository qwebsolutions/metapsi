...
public static partial class IonDatetimeControl
{
    ...
    public static void OnIonChange<TModel>(this PropsBuilder<IonDatetime> b, Var<HyperType.Action<TModel, DatetimeChangeEventDetail>> action)
    {
        ...
        {
            var value = b.GetDynamic(eventArgs, new DynamicProperty<DatetimeChangeEventDetail>("detail"));
            return b.MakeActionDescriptor<TModel, DatetimeChangeEventDetail>(action, value);
        });
    ...
    public static void OnIonChange<TModel>(this PropsBuilder<IonDatetime> b, System.Func<SyntaxBuilder, Var<TModel>, Var<DatetimeChangeEventDetail>, Var<TModel>> action)
    {
        ...
        {
            var value = b.GetDynamic(eventArgs, new DynamicProperty<DatetimeChangeEventDetail>("detail"));
            return b.MakeActionDescriptor<TModel, DatetimeChangeEventDetail>(b.MakeAction(action), value);
        });
        b.SetDynamic(b.Props, new DynamicProperty<HyperType.Action<TModel, object>>("onionChange"), eventAction);
    }
