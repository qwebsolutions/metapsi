...
public static partial class IonLoadingControl
{
    ...
    {
        return b.IonicTag("ion-loading", new Dictionary<string, string>(), children);
    }
    /// <summary>
    ///
    /// </summary>
    public static IHtmlNode IonLoading(this HtmlBuilder b, Action<AttributesBuilder<IonLoading>> buildAttributes, List<IHtmlNode> children)
    {
        return b.IonicTag("ion-loading", buildAttributes, children);
    }
    /// <summary>
    ///
    /// </summary>
    public static IHtmlNode IonLoading(this HtmlBuilder b, List<IHtmlNode> children)
    {
        return b.IonicTag("ion-loading", new Dictionary<string, string>(), children);
    }
    /// <summary>
    ...
    /// </summary>
    public static void SetHtmlAttributes<T>(this PropsBuilder<T> b, Var<object> htmlAttributes) where T: IonLoading
    {
    ...
    /// <para> Additional attributes to pass to the loader. </para>
    /// </summary>
    public static void SetHtmlAttributes<T>(this PropsBuilder<T> b, object htmlAttributes) where T: IonLoading
    {
