...
public static partial class IonCardSubtitleControl
{
    ...
    {
        return b.IonicTag("ion-card-subtitle", new Dictionary<string, string>(), children);
    }
    /// <summary>
    ///
    /// </summary>
    public static IHtmlNode IonCardSubtitle(this HtmlBuilder b, Action<AttributesBuilder<IonCardSubtitle>> buildAttributes, List<IHtmlNode> children)
    {
        return b.IonicTag("ion-card-subtitle", buildAttributes, children);
    }
    /// <summary>
    ///
    /// </summary>
    public static IHtmlNode IonCardSubtitle(this HtmlBuilder b, List<IHtmlNode> children)
    {
        return b.IonicTag("ion-card-subtitle", new Dictionary<string, string>(), children);
    }
    /// <summary>
