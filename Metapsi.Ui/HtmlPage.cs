...
namespace Metapsi
{
    ...
    //public abstract class ClientSidePage<TDataModel> : IPageTemplate<TDataModel>
    //{
    ...
    //    public abstract string GetPageTitle(TDataModel dataModel);
    //    public virtual string GetFaviconPath(TDataModel dataModel)
    //    {
    //        return string.Empty;
    //    }
    ...
    //public abstract class HyperPageTemplate<TDataModel> : IPageTemplate<TDataModel>
    //{
    //    public abstract string GetPageTitle(TDataModel dataModel);
    //    public virtual string GetFaviconPath(TDataModel dataModel)
    //    {
    ...
    //    private static Module BuildMain(
